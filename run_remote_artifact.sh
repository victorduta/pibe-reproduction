...
[[ !  -z  $2  ]] || exit
[[ !  -z  $3  ]] || exit
CONFIGS=(baseline.noopt alldefenses.noopt alldefenses.pibe-opt.lmbench-work.999999 alldefenses.pibe-opt.apache-work.999999 +retpolines.noopt +retpolines.pibe-opt.lmbench-work.999990   +retretpolines.noopt +retretpolines.pibe-opt.lmbench-work.999999 +lvi.noopt +lvi.pibe-opt.lmbench-work.999999 ) 
