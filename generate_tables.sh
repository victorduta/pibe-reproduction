...
./visualise_tables.sh -baselines test.baseline.noopt -benchmarks test.alldefenses.noopt test.alldefenses.pibe-opt.lmbench-work.999999  test.alldefenses.pibe-opt.apache-work.999999 -sablon 'Regular LTO' '99.9999(\%) LMBench work.' '99.9999(\%) Apache work.' > paper/tables/test-eval-lmbench-all.tex

./visualise_tables.sh -sablon 'regular LTO' '+icp (99.999\%)' -only-retpolines-test > paper/tables/test-eval-retpolines.tex
...
./visualise_tables.sh -baselines baseline.noopt -benchmarks alldefenses.noopt alldefenses.pibe-opt.lmbench-work.999999  alldefenses.pibe-opt.apache-work.999999 -sablon 'Regular LTO' '99.9999(\%) LMBench work.' '99.9999(\%) Apache work.' > paper/tables/eval-lmbench-all.tex

./visualise_tables.sh -sablon 'regular LTO' '+icp (99.999\%)' -only-retpolines > paper/tables/eval-retpolines.tex
...
cd paper && pdflatex reproduced.tex && cd ..
